...
public static class EventBusConfigurationBuilderExtensions
{
	public static EventBusConfigurationBuilder ConfigurePostgreSql(
		this EventBusConfigurationBuilder builder,
